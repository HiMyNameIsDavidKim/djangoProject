...
SECRET_KEY = "django-insecure-hw1ba2r#5v#z^b4f@lc&l0-d0ppw3==-#c@3(9)$s-wf4qad(6"
...
INSTALLED_APPS = [
    ...
    # "moviee.cinemas.apps.CinemasConfig",
    # "moviee.movies.apps.MoviesConfig",
    # "moviee.musers.apps.MusersConfig",
    # "moviee.showtimes.apps.ShowtimesConfig",
    # "moviee.theater_tickets.apps.TheaterTicketsConfig",
    # "moviee.theaters.apps.TheatersConfig",
